...
# fourth chart shows rural population vs arable land
    ...
    for country in countrylist:
      ...
      graph_four.append(
          ...
          text = text,
          name = country,
          #textposition = 'top' # This seems to break the build
          )
      )
    ...
    figures = []
    figures.append(dict(data=graph_one, layout=layout_one, config ={responsive: true}))
    figures.append(dict(data=graph_two, layout=layout_two, config ={responsive: true}))
    figures.append(dict(data=graph_three, layout=layout_three, config ={responsive: true}))
    figures.append(dict(data=graph_four, layout=layout_four, config ={responsive: true}))
    figures.append(dict(data=graph_five, layout=layout_five, config ={responsive: true}))
